...
async function checkAndCreateMessagingTables() {
  ...
  try {
    ...
    if (!tableExists) {
      ...
      // This is safer than running the whole file as one query
      ...
      await client.query(`
        ...
        END $$;
      `);
      console.log('  ✓ Conversations RLS policies created');
      ...
      await client.query(`
        ...
        END $$;
      `);
      console.log('  ✓ Message attachments RLS policies created');
