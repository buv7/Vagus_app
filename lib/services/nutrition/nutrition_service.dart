...
class NutritionService {
  ...
  Future<NutritionPlan?> fetchPlan(String planId) async {
    try {
      ...
      return NutritionPlan.fromMap(response as Map<String, dynamic>);
    } catch (e) {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          build: (pw.Context context) => [
            ...
            // Meals
            ...plan.meals.map((meal) => _buildMealSection(meal)).toList(),
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              pw.Column(
                children: [
                  pw.Text('Protein', style: pw.TextStyle(fontSize: 12)),
                  pw.Text(
              ...
              pw.Column(
                children: [
                  pw.Text('Carbs', style: pw.TextStyle(fontSize: 12)),
                  pw.Text(
              ...
              pw.Column(
                children: [
                  pw.Text('Fat', style: pw.TextStyle(fontSize: 12)),
                  pw.Text(
              ...
              pw.Column(
                children: [
                  pw.Text('Calories', style: pw.TextStyle(fontSize: 12)),
                  pw.Text(
