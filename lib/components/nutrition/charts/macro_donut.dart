...
class MacroDonut extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final segs = [
      (p / total, DesignTokens.accentBlue), // protein - blue
      (c / total, DesignTokens.accentPink), // carbs - pink
      (f / total, DesignTokens.accentGreen), // fat - green
    ];
...
class _DonutPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // inner hole
    final hole = Paint()..color = DesignTokens.primaryDark;
    canvas.drawCircle(
