                ...
                children: [
                  ...
                  if (_clients.isEmpty)
                    Container(
                      ...
                      child: Text(
                        LocaleHelper.t('no_clients_add_first', Localizations.localeOf(context).languageCode),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        labelText: LocaleHelper.t('client', Localizations.localeOf(context).languageCode),
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return LocaleHelper.t('please_select_client', Localizations.localeOf(context).languageCode);
                        }
                        return null;
                      },
                    ),
